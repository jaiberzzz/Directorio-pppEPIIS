<x-admin-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Registrar Nuevo Practicante') }}
        </h2>
    </x-slot>
                    ...
                    <form action="{{ route('admin.practitioners.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2 border-b pb-4 mb-4">
                                <h3 class="text-lg font-medium text-gray-900 mb-4">Datos del Estudiante</h3>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label for="student_name" class="block text-sm font-medium text-gray-700">Nombre
                                            Completo</label>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500 mt-1">Si el correo ya existe, se vinculará al
                                            usuario existente. Si no, se creará uno nuevo (Clave: DNI).</p>
                                    </div>
                                </div>
                            </div>

                            <h3 class="text-lg font-medium text-gray-900 md:col-span-2 mb-2">Datos de la Práctica</h3>
                            ...
                            <div>
                                ...
                                <input type="text" name="student_code" id="student_code"
                                    value="{{ old('student_code') }}" required maxlength="6" pattern="\d*"
                            ...
                            <div>
                                ...
                                <input type="text" name="phone" id="phone" value="{{ old('phone') }}" maxlength="9"
                            ...
                            <!-- Semester -->
                            <div>
                                <label for="semester" class="block text-sm font-medium text-gray-700">Semestre (ej.
                                    24-1)</label>
                            ...
                            <div>
                                ...
                                <input type="text" name="practice_area" id="practice_area"
                                    value="{{ old('practice_area') }}" required
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            </div>
